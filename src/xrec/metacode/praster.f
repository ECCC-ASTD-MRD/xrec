...
#include "endian.cdk"
     ...
     +        TAJUSTX(24)
      integer hpier, hpabt
      CHARACTER(LEN=128) CLE(64) , DEF1(64), VAL(64), DN
      CHARACTER(LEN=8)   TABDEV(24), TFORMSC(24), CDATE, TABDN(24),
     +      USAGER,TABTID(24), TPROTOC(24), CTIME, PROTOCL, UN, JOBN    
      CHARACTER(LEN=2)   FC, MF
