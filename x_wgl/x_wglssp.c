...
f77name(wglssp)(xdebut, ydebut, xfin, yfin, idebut, jdebut, ifin, jfin, mode)
float *xdebut, *ydebut, *xfin, *yfin;
int *idebut, *jdebut, *ifin, *jfin, *mode;
{
   wglssp(*xdebut, *ydebut, *xfin, *yfin, *idebut, *jdebut, *ifin, *jfin, *mode);
   }
...
int idebut, jdebut, ifin, jfin, mode;
{
   ...
   if (wglForceAspect)
	 ...
	 wglxai(&usSpace.ifin, &usSpace.jfin, xfin, yfin);
      }
